  ...
  return (
    <div className={cx('Intro')}>
      <div className={cx('Intro-page1')}>
        <div className={cx('Intro-page1-left')}>
        ...
        <div className={cx('Intro-page1-right')}>
      ...
      <div className={cx('Intro-page2')}>
        <div className={cx('Intro-page2-left')}>
        ...
        <div className={cx('Intro-page2-right')}>
      ...
      <div className={cx('Intro-page3')}>
        <div className={cx('Intro-page3-top')}>
          <div className={cx('Intro-page3-top-left')}>
          ...
          <div className={cx('Intro-page3-top-right')}>
        ...
        <div className={cx('Intro-page3-bottom')}>
          <Button
            customStyle={{width:'300px', height:'100px', fontSize: size.s6}}
            appearance={'outline'}
